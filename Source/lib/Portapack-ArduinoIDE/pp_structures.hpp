 ...
 * https://github.com/htotoo/ESP32-Portapack/blob/main/Source/main/ppi2c/pp_structures.h
 *
 * Modifications made by ubermood:
 *   1) Add a prefix to 'app_location_t' enum member names, since they collided with other declarations
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
